...
if __name__ == '__main__':
    ...
    base_file_path = "/Volumes/External/sales_bot/DouyinLive/Blackyardtechnology/2024-08-29/Blackyardtechnology_2024-08-29_00-08-22_danmu_{:03d}.txt"
    print(base_file_path.format(0))
